...
import pytest
from pandas import (CategoricalIndex, Index, MultiIndex, RangeIndex, Series,
                    Timestamp)
from pandas.api.types import (is_bool_dtype, is_datetime64tz_dtype,
                              is_signed_integer_dtype, pandas_dtype)
